# Seedance 2.0 API (seedance-2.0 / seedance2.0) — 4k guide with published pricing
...
**[Live pricing](https://go.apimart.ai/k-61bed6)** · **[Get an API key](https://go.apimart.ai/k-0a4521)**
